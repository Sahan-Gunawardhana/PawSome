    ...
    <div class="admin-main">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col space-y-8">
                    ...
                    <div class="flex items-center bg-white border border-gray-300 rounded-2xl shadow-lg overflow-hidden p-6">
                        <div class="flex-shrink-0 w-1/3 lg:w-1/4">
                            <img src="<?php echo e(asset($pro->pro_image_url)); ?>" alt="<?php echo e($pro->pro_name); ?>" class="w-full h-40 object-cover rounded-md ">
                        </div>
                        <div class="flex-1 px-6 flex flex-col justify-center space-y-4">
                            <h2 class="text-3xl font-semibold text-gray-900"><?php echo e($pro->pro_name); ?></h2>
                            <p class="text-2xl text-green-700 font-semibold"><?php echo e($pro->pro_price); ?></p>
                            <p class="text-lg text-gray-700">Keyword: <span class="font-medium"><?php echo e($pro->pro_keyword); ?></span></p>
                            <p class="text-lg text-gray-700">Shelf Life: <span class="font-medium"><?php echo e($pro->shelf_life); ?></span></p>
                            <p class="text-lg text-gray-700">Dimensions: <span class="font-medium"><?php echo e($pro->pro_width); ?> x <?php echo e($pro->pro_height); ?> x <?php echo e($pro->pro_length); ?></span></p>
                            <p class="text-lg text-gray-700"><?php echo e($pro->pro_description); ?></p>
                        </div>
                        <div class="flex flex-col items-center gap-4">
                            <a href="<?php echo e(url('product/edit/'.$pro->id)); ?>" class="neutral-button">EDIT</a>
                            <form action="<?php echo e(url('product/delete')); ?>" method="POST" class="w-full">
                                <?php echo csrf_field(); ?>
            ...
            <div class="bg-gray-50 p-6 rounded-2xl shadow-lg">
                ...
                <form action="<?php echo e(url('product/save')); ?>" enctype="multipart/form-data" method="post" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php echo $__env->make('layouts.adminheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sahangunawardhana/Downloads/SSP Submission/pawsome 2/resources/views/admin/manageP.blade.php ENDPATH**/ ?>